// src/app/scan.tsx
// Identyczny ze screenshotem:
// - Ciemne tło (aparat lub mock)
// - Zielone narożniki ramki
// - Ikona aparatu + "Skanowanie..." + zielony progress bar
// - 3 przyciski: Zdjęcie | Latarka | Ręcznie
// - Bottom: "Przyłóż kod QR lub kod kreskowy do ramki"
// - Tab bar widoczny na dole
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.overlay}>
        ...
        {/* Viewfinder — identyczny ze screenshotem */}
        ...
        <View style={styles.bottomActions}>
          <Pressable style={styles.actionBtn}>
            ...
            <Text style={styles.actionBtnText}>Zdjęcie</Text>
          </Pressable>
          <Pressable style={styles.actionBtn}>
            <Ionicons name="flashlight-outline" size={24} color={Colors.text.secondary} />
            <Text style={styles.actionBtnText}>Latarka</Text>
          </Pressable>
          <Pressable
          ...
          >
            ...
            <Text style={styles.actionBtnText}>Ręcznie</Text>
          </Pressable>
        </View>
...
const styles = StyleSheet.create({
  ...
  progressFill: { width: '60%', height: '100%', backgroundColor: Colors.accent.primary, borderRadius: 2 },
